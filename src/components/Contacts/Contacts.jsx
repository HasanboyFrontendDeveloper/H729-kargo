...
const Contacts = () => {
    return (
        <div className='lg:max-w-[1482px] md:max-w-[90%] max-w-[90%] mx-auto pt-5 pb-10 px-[103px] flex flex-col md:flex-row gap-[45px] '>
            <form className="bg-lightBlue max-w-[628px] max-h-[511px] pt-[50px] pl-[36px] pr-[39px] pb-[40px] flex flex-col gap-4 rounded-2xl ">
            ...
            <div className="my-[56.5px] max-w-[603px] ">

                <Typography className='text-primary sm:max-w-[603px] max-w-[350px] font-bold font-raleway !leading-[46.96px] md:text-[40px] sm:text-[30px] text-[24px] ' >
                    Рассчитайте стоимость доставки, отправив заявку
                </Typography>

                <Typography className='text-textPrimary sm:max-w-[603px] max-w-[90%] sm:text-lg text-sm !leading-[25.2px] font-normal font-raleway mt-5 ' >
                ...
                <div className="mt-[60px] ">
                    <div className="flex items-center gap-[30px] mb-[30px] ">
                        ...
                        <div className="py-[6.5px] ">

                            <Typography className='text-primary font-bold font-raleway xs:text-2xl text-base !leading-[28.18px]  ' >
                                WhatsApp & WeChat
                            </Typography>

                            <a href="tel:+86 19817983305" className='text-darkBlue font-normal font-raleway xs:text-lg text-sm !leading-[21.13px]'>
                                +86 19817983305
                            </a>
                        </div>
                    </div>
                    <div className="flex items-center gap-[30px] ">
                        ...
                        <div className="py-[6.5px] ">
                            ...
                            <a href="mailto:1325427621@qq.com" className='text-darkBlue font-normal font-raleway xs:text-lg text-sm !leading-[21.13px]'>
                                1325427621@qq.com
                            </a>
                        </div>
                    </div>
