...
const DeliveryCard = ({ item }) => {
    return (
        <div className='w-[290px] mx-auto bg-lightBlue rounded-3xl py-10 px-7 flex flex-col gap-2 hover:-translate-y-5 transition-all duration-300 '>
            ...
            <Button className='bg-primary py-5 hover:bg-darkBlue duration-300 ' >Заказать</Button>
